/**
 * Created by valeriu.jecov on 5/26/2018.
 */
...
test.describe('UofC', function () {
    ...
    test.describe('all logins - all environments', function () {
        var arrEnvUrls = [
            'https://dcmtst.aer.ca/UofC',        // tst
            'https://UofCuat.aer.ca/UofC',    // uat
            // 'https://UofC.aer.ca/UofC'        // prd
        ];
        var arrSectors = [
            'mi',   // mining
            'is',   // in-situ
